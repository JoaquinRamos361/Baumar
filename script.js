...
const PRODUCTS = [
  ...
  p("Coca Cero x 1.5Lts", "Coca", "bebidas-sin-alcohol", 29690, 3711.25, 8, "Coca Cero x 1.5Lts — bulto x8", "coca-cero-x-1-5lts", {}),
  p("Coca Light x 1.5Lts", "Coca", "bebidas-sin-alcohol", 29690, 3711.25, 8, "Coca Light x 1.5Lts — bulto x8", "coca-light-x-1-5lts", {}),
  ...
  p("VIDA by BAGGIO Saborizada 1.5Lts", "Vida", "bebidas-sin-alcohol", 30000, 5000, 6, "VIDA by BAGGIO Saborizada 1.5Lts — bulto x6", "vida-by-baggio-saborizada-1-5lts", {}),
  ...
  p("Fernet BRANCA x 750ml", "Branca", "bebidas-alcohol", 177240.01, 14770, 12, "Fernet BRANCA x 750ml — bulto x12", "fernet-branca-x-750ml", {}),
  p("Fernet BRANCA x 450ml", "Branca", "bebidas-alcohol", 103200, 8600, 12, "Fernet BRANCA x 450ml — bulto x12", "fernet-branca-x-450ml", {}),
  p("Fernet BRANCA Menta x 450ml", "Branca", "bebidas-alcohol", 103200, 8600, 12, "Fernet BRANCA Menta x 450ml — bulto x12", "fernet-branca-menta-x-450ml", {}),
  p("CARPANO Rosso x 950ml", "Carpano", "bebidas-alcohol", 45000, 7500, 6, "CARPANO Rosso x 950ml — bulto x6", "carpano-rosso-x-950ml", {}),
  p("CARPANO Bianco x 950ml", "Carpano", "bebidas-alcohol", 45000, 7500, 6, "CARPANO Bianco x 950ml — bulto x6", "carpano-bianco-x-950ml", {}),
  p("Vodka SERNOVA Original x 700ml", "Sernova", "bebidas-alcohol", 94200, 7850, 12, "Vodka SERNOVA Original x 700ml — bulto x12", "vodka-sernova-original-x-700ml", {}),
  p("Vodka SERNOVA Wild Berries x 700ml", "Sernova", "bebidas-alcohol", 47100, 7850, 6, "Vodka SERNOVA Wild Berries x 700ml — bulto x6", "vodka-sernova-wild-berries-x-700ml", {}),
  p("Vodka SERNOVA Sweet Apple x 700ml", "Sernova", "bebidas-alcohol", 47100, 7850, 6, "Vodka SERNOVA Sweet Apple x 700ml — bulto x6", "vodka-sernova-sweet-apple-x-700ml", {}),
  p("Vodka SERNOVA Trop.Passion x 700ml", "Sernova", "bebidas-alcohol", 47100, 7850, 6, "Vodka SERNOVA Trop.Passion x 700ml — bulto x6", "vodka-sernova-trop-passion-x-700ml", {}),
  ...
  p("Alfajores Guaymallen Dulce de Leche", "Alfajores", "galletitas", 9970, 249.25, 40, "Alfajores Guaymallen Dulce de Leche — bulto x40", "alfajores-guaymallen-dulce-de-leche", {}),
  ...
  p("Alfajores Guaymallen TRIPLE Dulce de Leche", "Triple", "galletitas", 9970, 415.42, 24, "Alfajores Guaymallen TRIPLE Dulce de Leche — bulto x24", "alfajores-guaymallen-triple-dulce-de", {}),
  ...
  p("Don Satur Bizcochos X 200GRS", "Don", "galletitas", 33300, 1110, 30, "Don Satur Bizcochos X 200GRS — bulto x30", "don-satur-bizcochos-x-200grs", {}),
  p("Don Satur Agridulce X 200GRS", "Don", "galletitas", 33300, 1110, 30, "Don Satur Agridulce X 200GRS — bulto x30", "don-satur-agridulce-x-200grs", {}),
  p("Don Satur Negritas X 200GRS", "Don", "galletitas", 33300, 1110, 30, "Don Satur Negritas X 200GRS — bulto x30", "don-satur-negritas-x-200grs", {}),
  p("Don Satur Magdalena x 220Grs", "Don", "galletitas", 22700, 2270, 10, "Don Satur Magdalena x 220Grs — bulto x10", "don-satur-magdalena-x-220grs", {}),
  p("Don Satur Talitas x 140g", "Don", "galletitas", 24200, 1210, 20, "Don Satur Talitas x 140g — bulto x20", "don-satur-talitas-x-140g", {}),
  ...
  p("Lucchetti Ave Maria x 500GRS", "Lucchetti", "fideos", 16800, 1120, 15, "Lucchetti Ave Maria x 500GRS — bulto x15", "lucchetti-ave-maria-x-500grs", {}),
  p("Lucchetti Dedalito x 500GRS", "Lucchetti", "fideos", 16800, 1120, 15, "Lucchetti Dedalito x 500GRS — bulto x15", "lucchetti-dedalito-x-500grs", {}),
  p("Lucchetti Municion x 500GRS", "Lucchetti", "fideos", 16800, 1120, 15, "Lucchetti Municion x 500GRS — bulto x15", "lucchetti-municion-x-500grs", {}),
  p("Lucchetti Letritas x 500GRS", "Lucchetti", "fideos", 16800, 1120, 15, "Lucchetti Letritas x 500GRS — bulto x15", "lucchetti-letritas-x-500grs", {}),
  p("Lucchetti Tirabuzon x 500Grs", "Lucchetti", "fideos", 16800, 1120, 15, "Lucchetti Tirabuzon x 500Grs — bulto x15", "lucchetti-tirabuzon-x-500grs", {}),
  p("Lucchetti Mostachol x 500Grs", "Lucchetti", "fideos", 16800, 1120, 15, "Lucchetti Mostachol x 500Grs — bulto x15", "lucchetti-mostachol-x-500grs", {}),
  p("Lucchetti Codito x 500Grs", "Lucchetti", "fideos", 16800, 1120, 15, "Lucchetti Codito x 500Grs — bulto x15", "lucchetti-codito-x-500grs", {}),
  p("Lucchetti Tallarin x 500Grs", "Lucchetti", "fideos", 22400, 1120, 20, "Lucchetti Tallarin x 500Grs — bulto x20", "lucchetti-tallarin-x-500grs", {}),
  p("Adobo para Pizzas x 20Grs", "Adobo", "condimentos", 24000, 480, 50, "Adobo para Pizzas x 20Grs — bulto x50", "adobo-para-pizzas-x-20grs", {}),
  p("Aji Molido x 25Grs", "Aji", "condimentos", 28000, 560, 50, "Aji Molido x 25Grs — bulto x50", "aji-molido-x-25grs", {}),
  p("Azucar Impalpable x 200Grs", "Azucar", "condimentos", 8900, 890, 10, "Azucar Impalpable x 200Grs — bulto x10", "azucar-impalpable-x-200grs", {}),
  p("Bicarbonato de Sodio x 50Grs", "Bicarbonato", "condimentos", 19000, 380, 50, "Bicarbonato de Sodio x 50Grs — bulto x50", "bicarbonato-de-sodio-x-50grs", {}),
  p("Chimi Churri Deshidratado x 25Grs", "Chimi", "condimentos", 23500, 470, 50, "Chimi Churri Deshidratado x 25Grs — bulto x50", "chimi-churri-deshidratado-x-25grs", {}),
  p("Coco Rayado x 25Grs", "Coco", "condimentos", 34000, 680, 50, "Coco Rayado x 25Grs — bulto x50", "coco-rayado-x-25grs", {}),
  p("Comino Molido x 25Grs", "Comino", "condimentos", 26500, 530, 50, "Comino Molido x 25Grs — bulto x50", "comino-molido-x-25grs", {}),
  p("Extracto de Vainilla x 100cc", "Extracto", "condimentos", 29760, 1240, 24, "Extracto de Vainilla x 100cc — bulto x24", "extracto-de-vainilla-x-100cc", {}),
  p("Granas para Reposteria x 50Grs", "Granas", "condimentos", 32500, 650, 50, "Granas para Reposteria x 50Grs — bulto x50", "granas-para-reposteria-x-50grs", {}),
  p("Grageas para Reposteria x 50Grs", "Grageas", "condimentos", 36000, 720, 50, "Grageas para Reposteria x 50Grs — bulto x50", "grageas-para-reposteria-x-50grs", {}),
  p("Oregano x 25Grs", "Oregano", "condimentos", 29500, 590, 50, "Oregano x 25Grs — bulto x50", "oregano-x-25grs", {}),
  p("Pimenton Seleccionado x 25Grs", "Pimenton", "condimentos", 26000, 520, 50, "Pimenton Seleccionado x 25Grs — bulto x50", "pimenton-seleccionado-x-25grs", {}),
  p("Pimienta Blanca Molida x 50Grs", "Pimienta", "condimentos", 101500, 2030, 50, "Pimienta Blanca Molida x 50Grs — bulto x50", "pimienta-blanca-molida-x-50grs", {}),
  p("Pimienta Negra Molida x 25grs", "Pimienta", "condimentos", 69000, 1380, 50, "Pimienta Negra Molida x 25grs — bulto x50", "pimienta-negra-molida-x-25grs", {}),
  p("Polvo para Hornear Centurion x 50Grs", "Polvo", "condimentos", 26500, 530, 50, "Polvo para Hornear Centurion x 50Grs — bulto x50", "polvo-para-hornear-centurion-x-50grs", {}),
  p("Provenzal Deshidratado x 25Grs", "Provenzal", "condimentos", 32000, 640, 50, "Provenzal Deshidratado x 25Grs — bulto x50", "provenzal-deshidratado-x-25grs", {}),
  ...
  p("Bocadito Marroc Cric 14Grs", "Bocadito", "chocolates", 2065200.06, 34420, 60, "Bocadito Marroc Cric 14Grs — bulto x60", "bocadito-marroc-cric-14grs", {}),
  ...
  p("Alfajor Guaymallen Blanco", "Guaymallen", "galletitas", 11150, 278.75, 40, "Alfajor Guaymallen Blanco — bulto x40", "alfajor-guaymallen-blanco", {}),
